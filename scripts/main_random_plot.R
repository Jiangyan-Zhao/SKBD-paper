...
#-------------- J = 5, phi = 0.3 -----------------------------------
vioplot(OC_J5p03, col = "grey",
        ylim = c(-18, 18),
        main = expression((b)*~J == 5*","~phi == 0.3),
        names = c("PCS", "PCA", "above-MTD", "ROD"))
mtext("Difference (SKBD − Keyboard)", side = 2, line = 2.5)
abline(h = 0, lty = 2)
points(1:ncol(OC_J5p03), colMeans(OC_J5p03), 
       pch = 24, cex = 1.1, bg = "white", col = "black")
legend("topright", inset = 0.02, bty = "n",
       legend = c("Median", "Mean"),
       pch    = c(21, 24),
...
#-------------- J = 6, phi = 0.2 -----------------------------------
vioplot(OC_J6p02, col = "grey",
        ylim = c(-18, 18),
        main = expression((c)*~J == 6*","~phi == 0.2),
        names = c("PCS", "PCA", "above-MTD", "ROD"))
mtext("Difference (SKBD − Keyboard)", side = 2, line = 2.5)
abline(h = 0, lty = 2)
points(1:ncol(OC_J6p02), colMeans(OC_J6p02), 
       pch = 24, cex = 1.1, bg = "white", col = "black")
legend("topright", inset = 0.02, bty = "n",
       legend = c("Median", "Mean"),
       pch    = c(21, 24),
...
#-------------- J = 6, phi = 0.3 -----------------------------------
vioplot(OC_J6p03, col = "grey",
        ylim = c(-18, 18),
        main = expression((d)*~J == 6*","~phi == 0.3),
        names = c("PCS", "PCA", "above-MTD", "ROD"))
mtext("Difference (SKBD − Keyboard)", side = 2, line = 2.5)
abline(h = 0, lty = 2)
points(1:ncol(OC_J6p03), colMeans(OC_J6p03), 
       pch = 24, cex = 1.1, bg = "white", col = "black")
legend("topright", inset = 0.02, bty = "n",
       legend = c("Median", "Mean"),
       pch    = c(21, 24),
