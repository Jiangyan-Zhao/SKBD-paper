...
load("results/KBD_fixed_tite.RData")
load("results/SKBD_fixed_tite.RData")

#------------------------------------------- plot -------------------------------------------
pdf("figures/fixed_accuracy_tite.pdf", width=8, height=8)
...
axis(1, at = 1:10)
axis(2, las=2)
legend(1, 80, legend=c("TITE-SKBD","TITE-Keyboard"), pch=c(15,1), lty=1, bty="n")
...
pdf("figures/fixed_safety_tite.pdf", width=8, height=8)
par(ps = 15, mfrow = c(2, 2), family="serif", mar=c(4,4,3,1))
...
axis(1, at = 1:10)
axis(2, las=2)
legend(5, 40, legend=c("TITE-SKBD","TITE-Keyboard"), pch=c(15,1), lty=1, bty="n")
