...
save(PCS_SKBD, PCA_SKBD, above_MTD_SKBD, ROD60_SKBD, monotonic_SKBD,
     file = "results/SKBD_fixed.RData")
...
save(PCS_KBD, PCA_KBD, above_MTD_KBD, ROD60_KBD, monotonic_KBD,
     file = "results/KBD_fixed.RData")
