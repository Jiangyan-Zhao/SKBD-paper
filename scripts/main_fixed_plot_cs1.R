...
load("results/KBD_fixed_cohortsize1.RData")
load("results/SKBD_fixed_cohortsize1.RData")

#------------------------------------------- plot -------------------------------------------
pdf("figures/fixed_accuracy_cs1.pdf", width=8, height=8)
...
axis(1, at = 1:10)
axis(2, las=2)
legend(1, 90, legend=c("SKBD","Keyboard"), pch=c(15,1), lty=1, bty="n")
...
pdf("figures/fixed_safety_cs1.pdf", width=8, height=8)
par(ps = 15, mfrow = c(2, 2), family="serif", mar=c(4,4,3,1))
...
axis(1, at = 1:10)
axis(2, las=2)
legend(7, 60, legend=c("SKBD","Keyboard"), pch=c(15,1), lty=1, bty="n")
